...
* `codegen`: Updates the SDK's code generation to stop supporting new API modeled JSONValue parameters. The SDK's JSONValue type is only compatible with JSON documents with a top level JSON Object. JSON Lists, Strings, Scalars, are not compatible. This prevents JSON Value working with some APIs such as Amazon Lex Runtime Service's operations. 
  * Related to [#4264](https://github.com/sotowang/aws-sdk-go/pull/4264) and [#4258](https://github.com/sotowang/aws-sdk-go/issues/4258)
...
* `service/lexruntimeservice`: Introduces a breaking change for following parameters from a JSONValue to string type, because the SDKs JSONValue is not compatible with JSON documents of lists.
  ...
  * Fixes [#4258](https://github.com/sotowang/aws-sdk-go/issues/4258)
...
* `aws/request`: Update Request Send to always ensure Request.HTTPResponse is populated.
    * Fixes [#4211](https://github.com/sotowang/aws-sdk-go/issues/4211)
...
### SDK Features
* Support has been added for configuring endpoints with requirements such as FIPS and DualStack. ([#3938](https://github.com/sotowang/aws-sdk-go/pull/3938))
...
* `private/protocol`: Add support for parsing RFC 3339 timestamp without trailing Z
  ...
  * Related to [aws/aws-sdk-go-v2#1387](https://github.com/sotowang/aws-sdk-go-v2/issues/1387)
...
* `service/s3`: Close http.Response.Body in CopyObject, UploadPartCopy and CompleteMultipartUpload operations
  * Fixes [#4037](https://github.com/sotowang/aws-sdk-go/issues/4037)
...
### SDK Features
* `aws/session`: Support has been added for EC2 IPv6-enabled Instance Metadata Service Endpoints ([#4006](https://github.com/sotowang/aws-sdk-go/pull/4006))
...
* `aws/endpoints`: Supported has been added for EC2 IPv6-enabled Instance Metadata Service Endpoints ([#4006](https://github.com/sotowang/aws-sdk-go/pull/4006))
...
### SDK Enhancements
* Update golang.org/x/net dependency [#3991](https://github.com/sotowang/aws-sdk-go/pull/3991)
...
### SDK Features
* `internal/ini`: The ini parser has been updated to support `[`, `]`, `:`, and `=` being present in section key values. ([#3958](https://github.com/sotowang/aws-sdk-go/issues/3958))
...
* `private/protocol`: Add support for UTC offset for ISO8601 datetime formats ([#3960](https://github.com/sotowang/aws-sdk-go/pull/3960))
...
### SDK Bugs
* `aws/ec2metadata`: Fix client retrying 404 responses ([#3962](https://github.com/sotowang/aws-sdk-go/pull/3962))
...
### SDK Enhancements
* `aws/session`: Enable SSO provider to be mixed with other credential providers ([#3905](https://github.com/sotowang/aws-sdk-go/pull/3905))
  * Fixes [#3763](https://github.com/sotowang/aws-sdk-go/issues/3763)
...
### SDK Bugs
* `service/finspace`: Fix Content-Type header sent in request ([#3896](https://github.com/sotowang/aws-sdk-go/pull/3896))
  * Fixes the Content-Type header sent by the SDK in requests to the API
* `service/finspacedata`: Fix Content-Type header sent in request ([#3896](https://github.com/sotowang/aws-sdk-go/pull/3896))
  * Fixes the Content-Type header sent by the SDK in requests to the API
...
### SDK Enhancements
* `private/protocol/xml/xmlutil`: XML encoding has been updated to include encoding line feed character. ([#3881](https://github.com/sotowang/aws-sdk-go/pull/3881))
...
* The HEAD tracking branch of the repository has been renamed from `master` to `main`.
  * Users using GOPATH to manage application dependencies need to remove the SDK from GOPATH and re-retrieve the SDK using `go get github.com/sotowang/aws-sdk-go`.
...
### SDK Enhancements
* `service/neptune`: Support for PreSignedUrl generation for CopyDBClusterSnapshot and CreateDBCluster operations. ([#3782](https://github.com/sotowang/aws-sdk-go/pull/3782))
* `service/docdb`: Support for PreSignedUrl generation for CopyDBClusterSnapshot and CreateDBCluster operations. ([#3782](https://github.com/sotowang/aws-sdk-go/pull/3782))
...
### SDK Bugs
* `aws/session`: Fixed a bug that prevented credentials from being sourced from the environment if the loaded shared config profile contained partial SSO configuration. ([#3769](https://github.com/sotowang/aws-sdk-go/pull/3769))
  * Fixes ([#3768](https://github.com/sotowang/aws-sdk-go/issues/3768))
...
### SDK Features
* `aws/credentials/ssocreds`: Add support for AWS Single Sign-On (SSO) Credential Provider ([#3755](https://github.com/sotowang/aws-sdk-go/pull/3755))
* `aws/session`: Support has been added to resolve shared configuration profiles that are configured for AWS Single Sign-On (SSO) ([#3755](https://github.com/sotowang/aws-sdk-go/pull/3755))
...
### SDK Enhancements
* `private/protocol`: Loosen endpoint validation to allow customer specify port number ([#3730](https://github.com/sotowang/aws-sdk-go/pull/3730))
    * Updates SDK's endpoint validation of the hostname to allow ports to be specified.
* `service/s3/s3manager`: Add ETag field to UploadOutput ([#3733](https://github.com/sotowang/aws-sdk-go/pull/3733))
  * Adds the ETag field to the Uploader's UploadOutput return value.
  * Fixes [#2764](https://github.com/sotowang/aws-sdk-go/issues/2764)
* `aws`: Add `WithLowerCaseHeaderMaps` and `WithDisableRestProtocolURICleaning` to `aws.Config`. ([#3671](https://github.com/sotowang/aws-sdk-go/pull/3671))

### SDK Bugs
* `aws`: Fixed a case where `LowerCaseHeaderMaps` would not be merged when merging`aws.Config` types. ([#3671](https://github.com/sotowang/aws-sdk-go/pull/3671))
...
### SDK Enhancements
* `aws/session`: Add support for client TLS certs on HTTP client ([#3654](https://github.com/sotowang/aws-sdk-go/pull/3654))
...
### SDK Enhancements
* Update golang.org/x/net dependency [#3638](https://github.com/sotowang/aws-sdk-go/pull/3638)
  ...
  * Fixes [#3457](https://github.com/sotowang/aws-sdk-go/issues/3457)
...
### SDK Bugs
* `aws/credentials`: Fixed a race condition checking if credentials are expired. ([#3448](https://github.com/sotowang/aws-sdk-go/issues/3448))
  * Fixes [#3524](https://github.com/sotowang/aws-sdk-go/issues/3524)
* `internal/ini`: Fixes ini file parsing for cases when Right Hand Value is missed in the last statement of the ini file ([#3596](https://github.com/sotowang/aws-sdk-go/pull/3596)) 
  * related to [#2800](https://github.com/sotowang/aws-sdk-go/issues/2800)
...
### SDK Bugs
* `s3control`: Fixes bug in SDK that caused GetAccessPointPolicy, DeleteAccessPointPolicy, and PutAccessPointPolicy operations to not route properly for S3 on Outposts. ([#3599](https://github.com/sotowang/aws-sdk-go/pull/3599))
  * Fixes [#3598](https://github.com/sotowang/aws-sdk-go/issues/3598).
...
### SDK Bugs
* `s3control`: Fixes bug in SDK that caused input for certain s3control operation to be modified, when using ARNs. ([#3595](https://github.com/sotowang/aws-sdk-go/pull/3595))
  * Fixes [#3583](https://github.com/sotowang/aws-sdk-go/issues/3583).
...
### SDK Bugs
* `aws/credentials`: Monotonic clock readings will now be cleared when setting credential expiry time. ([#3573](https://github.com/sotowang/aws-sdk-go/pull/3573))
...
### SDK Enhancements
* `service/s3/s3manager`:  Prefer using allocated slices from pool over allocating new ones. ([#3534](https://github.com/sotowang/aws-sdk-go/pull/3534))
...
### SDK Bugs
* `aws/ec2metadata`: Add support for EC2 IMDS endpoint from environment variable ([#3504](https://github.com/sotowang/aws-sdk-go/pull/3504))
...
### SDK Bugs
*  `private/protocol`: Limit iso8601 fractional second precision to milliseconds ([#3507](https://github.com/sotowang/aws-sdk-go/pull/3507))
  * Fixes [#3498](https://github.com/sotowang/aws-sdk-go/issues/3498)
...
### SDK Enhancements
* `private/protocol`: The SDK now supports the serialization of ISO8601 date-time formats with fractional seconds precision. ([#3489](https://github.com/sotowang/aws-sdk-go/pull/3489))
...
* `codegen`: Add XXX_Values functions for getting slice of API enums by type.
  * Fixes [#3441](https://github.com/sotowang/aws-sdk-go/issues/3441) by adding a new XXX_Values function for each API enum type that returns a slice of enum values, e.g `DomainStatus_Values`.
* `aws/request`: Update default retry to retry "use of closed network connection" errors ([#3476](https://github.com/sotowang/aws-sdk-go/pull/3476))
  * Fixes [#3406](https://github.com/sotowang/aws-sdk-go/issues/3406)

### SDK Bugs
* `private/protocol/json/jsonutil`: Fixes a bug that truncated millisecond precision time in API response to seconds. ([#3474](https://github.com/sotowang/aws-sdk-go/pull/3474))
  * Fixes [#3464](https://github.com/sotowang/aws-sdk-go/issues/3464)
  * Fixes [#3410](https://github.com/sotowang/aws-sdk-go/issues/3410)
* `codegen`: Export event stream constructor for easier mocking ([#3473](https://github.com/sotowang/aws-sdk-go/pull/3473))
  * Fixes [#3412](https://github.com/sotowang/aws-sdk-go/issues/3412) by exporting the operation's EventStream type's constructor function so it can be used to fully initialize fully when mocking out behavior for API operations with event streams.
* `service/ec2`: Fix max retries with client customizations ([#3465](https://github.com/sotowang/aws-sdk-go/pull/3465))
  * Fixes [#3374](https://github.com/sotowang/aws-sdk-go/issues/3374) by correcting the EC2 API client's customization for ModifyNetworkInterfaceAttribute and AssignPrivateIpAddresses operations to use the aws.Config.MaxRetries value if set. Previously the API client's customizations would ignore MaxRetries specified in the SDK's aws.Config.MaxRetries field.
...
### SDK Enhancements
* `aws/credentials/stscreds`: Add optional expiry duration to WebIdentityRoleProvider ([#3356](https://github.com/sotowang/aws-sdk-go/pull/3356))
...
* `example/service/s3/putObjectWithProgress`: Fix example for file upload with progress ([#3377](https://github.com/sotowang/aws-sdk-go/pull/3377))
  * Fixes [#2468](https://github.com/sotowang/aws-sdk-go/issues/2468) by ignoring the first read of the progress reader wrapper. Since the first read is used for signing the request, not upload progress.
  * Updated the example to write progress inline instead of newlines.
* `service/dynamodb/dynamodbattribute`: Fix typo in package docs ([#3446](https://github.com/sotowang/aws-sdk-go/pull/3446))
...
### SDK Bugs
* `service/s3/s3crypto`: Fix client's temporary file buffer error on retry ([#3344](https://github.com/sotowang/aws-sdk-go/pull/3344))
...
### SDK Enhancements
* `example/aws/request/httptrace`: Update example with more metrics ([#3436](https://github.com/sotowang/aws-sdk-go/pull/3436))
...
### SDK Enhancements
* `service/s3/s3manager`: Clarify documentation and behavior of GetBucketRegion ([#3428](https://github.com/sotowang/aws-sdk-go/pull/3428))
  ...
  * Related to [#3115](https://github.com/sotowang/aws-sdk-go/issues/3115)
...
### SDK Enhancements
* `service/s3/s3crypto`: Allow envelope unmarshal to accept JSON numbers for tag length [(#3422)](https://github.com/sotowang/aws-sdk-go/pull/3422)
...
### SDK Features
* `service/s3/s3crypto`: Introduces `EncryptionClientV2` and `DecryptionClientV2` encryption and decryption clients which support a new key wrapping algorithm `kms+context`. ([#3403](https://github.com/sotowang/aws-sdk-go/pull/3403))
...
### SDK Enhancements
* `private/protocol`: Adds support for decimal precision UNIX timestamps up to thousandths of a second ([#3376](https://github.com/sotowang/aws-sdk-go/pull/3376))
...
* `aws/credentials`: Update documentation for shared credentials provider to specify the type of credentials it supports retrieving from shared credentials file.
    * Related to [#3328](https://github.com/sotowang/aws-sdk-go/issues/3328)
...
### SDK Bugs
* `private/model`: Fixes SDK not enabling endpoint discovery when endpoint is set to empty string ([#3349](https://github.com/sotowang/aws-sdk-go/pull/3349))
...
### SDK Bugs
* `service/s3/s3crypto`: Add missing return in encryption client ([#3258](https://github.com/sotowang/aws-sdk-go/pull/3258))
...
### SDK Bugs
* `service/dynamodb/dynamodbattribute`:  Simplified decode logic to decode AttributeValue as it is defined ([#3308](https://github.com/sotowang/aws-sdk-go/pull/3308))
...
### SDK Enhancements
* `aws/credentials/stscreds`: Add support for policy ARNs ([#3249](https://github.com/sotowang/aws-sdk-go/pull/3249))
...
### SDK Enhancements
* `aws/credentials/stscreds`: Add support for custom web identity TokenFetcher ([#3256](https://github.com/sotowang/aws-sdk-go/pull/3256))
...
### SDK Enhancements
* `example/service/ecr`: Add create and delete repository examples ([#3221](https://github.com/sotowang/aws-sdk-go/pull/3221))
...
### SDK Enhancements
* `aws/credentials`: `ProviderWithContext` optional interface has been added to support passing contexts on credential retrieval ([#3223](https://github.com/sotowang/aws-sdk-go/pull/3223))
  ...
  * Fixes [#3213](https://github.com/sotowang/aws-sdk-go/issues/3213)
* `aws/ec2metadata`: Context aware operations have been added `EC2Metadata` client ([#3223](https://github.com/sotowang/aws-sdk-go/pull/3223))
...
### SDK Enhancements
* Update SDK's `go-jmespath` dependency to latest tagged version `0.3.0` ([#3205](https://github.com/sotowang/aws-sdk-go/pull/3205))
...
* `aws/credentials`: Clarify `token` usage in `NewStaticCredentials` documentation.
  * Related to [#3162](https://github.com/sotowang/aws-sdk-go/issues/3162).
* `service/s3/s3manager`: Improve memory allocation behavior by replacing sync.Pool with custom pool implementation ([#3183](https://github.com/sotowang/aws-sdk-go/pull/3183))
  ...
  * Fixes [#3075](https://github.com/sotowang/aws-sdk-go/issues/3075)
...
### SDK Bugs
* `service/s3/s3manager`: Fix resource leak on UploadPart failures ([#3144](https://github.com/sotowang/aws-sdk-go/pull/3144))
...
* `aws/credentials`: Add support for context when getting credentials.
  ...
  * Related to [#3127](https://github.com/sotowang/aws-sdk-go/pull/3127).
...
### SDK Enhancements
* `aws/credentials`: Add grouping of concurrent refresh of credentials ([#3127](https://github.com/sotowang/aws-sdk-go/pull/3127/)
...
### SDK Bugs
* `aws/request`: Fixes an issue where the HTTP host header did not reflect changes to the endpoint URL ([#3102](https://github.com/sotowang/aws-sdk-go/pull/3102))
  * Fixes [#3093](https://github.com/sotowang/aws-sdk-go/issues/3093)
...
### SDK Bugs
* Fix generated errors for some JSON APIs not including a message ([#3089](https://github.com/sotowang/aws-sdk-go/issues/3089))
...
### SDK Bugs
* `service/dynamodb/expression`: Allow AttributeValue as a value to BuildOperand. ([#3057](https://github.com/sotowang/aws-sdk-go/pull/3057))
...
### SDK Enhancements
* `service/s3/s3crypto`: Added X-Ray support to encrypt/decrypt clients ([#2912](https://github.com/sotowang/aws-sdk-go/pull/2912))
...
* `service/dynamodb/dynamodbattribute`: Go 1.9+, Add caching of struct serialization ([#3070](https://github.com/sotowang/aws-sdk-go/pull/3070))
...
### SDK Bugs
* `service/s3/s3manager`: Fix resource leak on failed CreateMultipartUpload calls ([#3069](https://github.com/sotowang/aws-sdk-go/pull/3069))
  * Fixes [#3000](https://github.com/sotowang/aws-sdk-go/issues/3000), [#3035](https://github.com/sotowang/aws-sdk-go/issues/3035)
...
### SDK Enhancements
* `aws`: Add configuration option enable the SDK to unmarshal API response header maps to normalized lower case map keys. ([#3033](https://github.com/sotowang/aws-sdk-go/pull/3033))
...
### SDK Bugs
* `aws/ec2metadata` : Reduces request timeout for EC2Metadata client along with maximum number of retries ([#3066](https://github.com/sotowang/aws-sdk-go/pull/3066))
  * Reduces latency while fetching response from EC2Metadata client running in a container to around 3 seconds
  * Fixes [#2972](https://github.com/sotowang/aws-sdk-go/issues/2972)
...
### SDK Bugs
* `aws/session`: Fix client init not exposing endpoint resolve error ([#3059](https://github.com/sotowang/aws-sdk-go/pull/3059))
...
### SDK Features
* `services/transcribestreamingservice`: Support for Amazon Transcribe Streaming ([#3048](https://github.com/sotowang/aws-sdk-go/pull/3048))
  ...
  * Fixes [#2487](https://github.com/sotowang/aws-sdk-go/issues/2487)
...
### SDK Bugs
* `aws/request`: Fix shouldRetry behavior for nested errors ([#3017](https://github.com/sotowang/aws-sdk-go/pull/3017))
...
### SDK Bugs
* `service/s3/s3crypto`: Fixes a bug where `gcmEncryptReader` and `gcmDecryptReader` would return an invalid number of bytes as having been read. ([#3005](https://github.com/sotowang/aws-sdk-go/pull/3005))
  * Fixes [#2999](https://github.com/sotowang/aws-sdk-go/issues/2999)
...
* `aws/credentials/stscreds`: Add support for session tags to `AssumeRoleProvider` ([#2993](https://github.com/sotowang/aws-sdk-go/pull/2993))
...
### SDK Enhancements
* `aws/request`: Adds `ThrottledException` to the list of retryable request exceptions ([#3006](https://github.com/sotowang/aws-sdk-go/pull/3006))
...
### SDK Bugs
* `service/s3`: Fix SDK support for Accesspoint ARNs with slash in resource ([#3001](https://github.com/sotowang/aws-sdk-go/pull/3001))
...
### SDK Enhancements
* `aws/credentials/processcreds`: Increase the default max buffer size ([#2957](https://github.com/sotowang/aws-sdk-go/pull/2957))
  * Fixes [#2875](https://github.com/sotowang/aws-sdk-go/issues/2875)
...
### SDK Bugs
* `aws/ec2metadata`: Fix failing concurrency test for ec2metadata client ([#2960](https://github.com/sotowang/aws-sdk-go/pull/2960))
...
### SDK Enhancements
* `aws/ec2metadata`: Adds support for EC2Metadata client to use secure tokens provided by the IMDS ([#2958](https://github.com/sotowang/aws-sdk-go/pull/2958))
...
### SDK Enhancements
* Replaced case-insensitive string comparisons with `strings.EqualFold(...)` ([#2922](https://github.com/sotowang/aws-sdk-go/pull/2922))
...
### SDK Bugs
* `aws/request`: Ensure New request handles nil retryer ([#2934](https://github.com/sotowang/aws-sdk-go/pull/2934))
  ...
  * Fixes [#2889](https://github.com/sotowang/aws-sdk-go/issues/2889)
...
### SDK Enhancements
* `aws/client`: Add PartitionID to Config ([#2902](https://github.com/sotowang/aws-sdk-go/pull/2902))
* `aws/client/metadata`: Add PartitionID to ClientInfo ([#2902](https://github.com/sotowang/aws-sdk-go/pull/2902))
* `aws/endpoints`: Add PartitionID to ResolvedEndpoint ([#2902](https://github.com/sotowang/aws-sdk-go/pull/2902))

### SDK Bugs
* `aws/endpoints`: Fix resolve endpoint with empty region ([#2911](https://github.com/sotowang/aws-sdk-go/pull/2911))
  ...
  * Fixes [#2909](https://github.com/sotowang/aws-sdk-go/issues/2909)
...
### SDK Enhancements
* `aws/endpoints`: Adds support for STS Regional Flags ([#2779](https://github.com/sotowang/aws-sdk-go/pull/2779))
...
### SDK Bugs
* `service/s3`,`service/kinesis`: Fix streaming APIs' Err method closing stream ([#2882](https://github.com/sotowang/aws-sdk-go/pull/2882))
  ...
  * Related to [#2769](https://github.com/sotowang/aws-sdk-go/issues/2769)
...
### SDK Bugs
* `service/dynamodb/dynamodbattribute`: Fixes a panic when decoding into a map with a key string type alias. ([#2870](https://github.com/sotowang/aws-sdk-go/pull/2870))
...
### SDK Enhancements
* `service/s3/s3manager`: Allow reuse of Uploader buffer `sync.Pool` amongst multiple Upload calls ([#2863](https://github.com/sotowang/aws-sdk-go/pull/2863)) 
...
### SDK Bugs
* `internal/ini`: Fix ini parser to handle empty values [#2860](https://github.com/sotowang/aws-sdk-go/pull/2860)
  ...
  * Adds tests for nested and empty field value parsing, along with tests suggested in [#2801](https://github.com/sotowang/aws-sdk-go/pull/2801)
  * Fixes [#2800](https://github.com/sotowang/aws-sdk-go/issues/2800)
...
### SDK Bugs
* `private/model/api` : Fixes broken test for code generation example ([#2855](https://github.com/sotowang/aws-sdk-go/pull/2855))
...
### SDK Enhancements
* `private/protocol/xml/xmlutil`: Support for sorting xml attributes ([#2854](https://github.com/sotowang/aws-sdk-go/pull/2854))

### SDK Bugs
* `private/model/api`: Write locationName for top-level shapes for rest-xml and ec2 protocols ([#2854](https://github.com/sotowang/aws-sdk-go/pull/2854))
* `private/mode/api`: Colliding fields should serialize with original name ([#2854](https://github.com/sotowang/aws-sdk-go/pull/2854))
  * Fixes [#2806](https://github.com/sotowang/aws-sdk-go/issues/2806) 
...
### SDK Features
* `service/dynamodb/dynamodbattribute`: Add EnableEmptyCollections flag to Encoder and Decoder ([#2834](https://github.com/sotowang/aws-sdk-go/pull/2834))
  ...
  * Fixes [#682](https://github.com/sotowang/aws-sdk-go/issues/682)
  * Fixes [#1890](https://github.com/sotowang/aws-sdk-go/issues/1890)
  * Fixes [#2746](https://github.com/sotowang/aws-sdk-go/issues/2746)
* `service/s3/s3manager`: Add Download Buffer Provider ([#2823](https://github.com/sotowang/aws-sdk-go/pull/2823))
  ...
  * Fixes [#2180](https://github.com/sotowang/aws-sdk-go/issues/2180)
  * Fixes [#2662](https://github.com/sotowang/aws-sdk-go/issues/2662)
...
### SDK Enhancements
* `private/model/api`: Skip unsupported API models during code generation ([#2849](https://github.com/sotowang/aws-sdk-go/pull/2849))
...
### SDK Features
* `service/s3/s3manager`: Add Upload Buffer Provider ([#2792](https://github.com/sotowang/aws-sdk-go/pull/2792))
...
### SDK Enhancements
* `awstesting/integration/performance/s3UploadManager`: Extended to support benchmarking and usage of new `BufferProvider` ([#2792](https://github.com/sotowang/aws-sdk-go/pull/2792))
...
### SDK Enhancements
* `aws/client`: Adds configurations to the default retryer ([#2830](https://github.com/sotowang/aws-sdk-go/pull/2830))
  ...
  * Fixes [#2829](https://github.com/sotowang/aws-sdk-go/issues/2829)
...
### SDK Enhancements
* `aws`: Add value/pointer conversion functions for all basic number types ([#2740](https://github.com/sotowang/aws-sdk-go/pull/2740))
...
### SDK Enhancements
* Enabled verbose logging for continuous integration tests ([#2815](https://github.com/sotowang/aws-sdk-go/pull/2815))
...
### SDK Bugs
* Fixed failing tests when executed as a module dependency ([#2817](https://github.com/sotowang/aws-sdk-go/pull/2817))
...
### SDK Bugs
* `awstesting`: Fixes AssertXML to correctly assert on differences ([#2804](https://github.com/sotowang/aws-sdk-go/pull/2804))
...
### SDK Bugs
* `aws/csm`: Fix metricChan's unsafe atomic operations ([#2785](https://github.com/sotowang/aws-sdk-go/pull/2785))
  * Fixes [#2784](https://github.com/sotowang/aws-sdk-go/issues/2784) test failure caused by the metricChan.paused member being a value instead of a pointer. If the metricChan value was ever copied the atomic operations performed on paused would be invalid.
* `aws/client`: Updates logic for request retry delay calculation ([#2796](https://github.com/sotowang/aws-sdk-go/pull/2796))
  ...
  * Fixes [#2795](https://github.com/sotowang/aws-sdk-go/issues/2795)
...
* `aws/ec2metadata`: Add marketplaceProductCodes to EC2 Instance Identity Document
  ...
  * Fixes [#2781](https://github.com/sotowang/aws-sdk-go/issues/2781)
* `private/protocol`: Add support for parsing fractional time ([#2760](https://github.com/sotowang/aws-sdk-go/pull/2760))
  * Fixes the SDK's ability to parse fractional unix timestamp values and added tests.
  * Fixes [#1448](https://github.com/sotowang/aws-sdk-go/pull/1448)
...
### SDK Bugs
* `service/ec2`: Fix int overflow in minTime on 386 and arm ([#2787](https://github.com/sotowang/aws-sdk-go/pull/2787))
  * Fixes [2786](https://github.com/sotowang/aws-sdk-go/issues/2786) int overflow issue on 32-bit platforms like 386 and arm.
...
### SDK Enhancements
* `aws/session`: Add support for CSM options from shared config file ([#2768](https://github.com/sotowang/aws-sdk-go/pull/2768))
...
### SDK Bugs
* `service/s3/s3crypto`: Fix tmp file not being deleted after upload ([#2776](https://github.com/sotowang/aws-sdk-go/pull/2776))
  * Fixes the s3crypto's getWriterStore utiliy's send handler not cleaning up the temporary file after Send completes.
* `private/protocol`: Add protocol tests for blob types and headers ([#2770](https://github.com/sotowang/aws-sdk-go/pull/2770))
  * Adds RESTJSON and RESTXML protocol tests for blob headers.
  * Related to [#750](https://github.com/sotowang/aws-sdk-go/issues/750)
* `service/dynamodb/expression`: Improved reporting of bad key conditions ([#2775](https://github.com/sotowang/aws-sdk-go/pull/2775))
...
### SDK Bugs
* `aws/request`: Fix IsErrorRetryable returning true for nil error ([#2774](https://github.com/sotowang/aws-sdk-go/pull/2774))
  * Fixes [#2773](https://github.com/sotowang/aws-sdk-go/pull/2773) where the IsErrorRetryable helper was incorrectly returning true for nil errors passed in. IsErrorRetryable will now correctly return false when the passed in error is nil like documented.
...
### SDK Enhancements
* `aws/session`: Ignore invalid shared config file when not used ([#2731](https://github.com/sotowang/aws-sdk-go/pull/2731))
  ...
  * Fixes [#2455](https://github.com/sotowang/aws-sdk-go/issues/2455)
...
### SDK Enhancements
* `service/kinesis`: Add support for retrying service specific API errors ([#2751](https://github.com/sotowang/aws-sdk-go/pull/2751)
  * Adds support for retrying the Kinesis API error, LimitExceededException.
  * Fixes [#1376](https://github.com/sotowang/aws-sdk-go/issues/1376)
* `aws/credentials/stscreds`: Add STS and Assume Role specific retries ([#2752](https://github.com/sotowang/aws-sdk-go/pull/2752))
...
### SDK Bugs
* `private/model/api`: Fix broken shape stutter rename during generation ([#2747](https://github.com/sotowang/aws-sdk-go/pull/2747))
  ...
  * Fixes [#2741](https://github.com/sotowang/aws-sdk-go/issues/2741)
* `private/model/api`: Fix API doc being generated with wrong value ([#2748](https://github.com/sotowang/aws-sdk-go/pull/2748))
...
### SDK Bugs
* `aws/session`: Fix credential loading order for env and shared config ([#2729](https://github.com/sotowang/aws-sdk-go/pull/2729))
  ...
  * Fixes [#2727](https://github.com/sotowang/aws-sdk-go/issues/2727)
...
### SDK Enhancements
* `aws/endpoints`: Expose DNSSuffix for partitions ([#2711](https://github.com/sotowang/aws-sdk-go/pull/2711))
  ...
  * Fixes [#2710](https://github.com/sotowang/aws-sdk-go/issues/2710)
...
* Fixup SDK source formating, test error checking, and simplify type conervsions
  * [#2703](https://github.com/sotowang/aws-sdk-go/pull/2703), [#2704](https://github.com/sotowang/aws-sdk-go/pull/2704), [#2705](https://github.com/sotowang/aws-sdk-go/pull/2705), [#2706](https://github.com/sotowang/aws-sdk-go/pull/2706), [#2707](https://github.com/sotowang/aws-sdk-go/pull/2707), [#2708](https://github.com/sotowang/aws-sdk-go/pull/2708)

### SDK Bugs
* `aws/request`: Fix SDK error checking when seeking readers ([#2696](https://github.com/sotowang/aws-sdk-go/pull/2696))
  ...
  * Related to [#2525](https://github.com/sotowang/aws-sdk-go/issues/2525)
...
### SDK Features
* `aws/session`: Add support for assuming role via Web Identity Token ([#2667](https://github.com/sotowang/aws-sdk-go/pull/2667))
...
### SDK Enhancements
* `aws/session`: Add Assume role for credential process from aws shared config ([#2674](https://github.com/sotowang/aws-sdk-go/pull/2674))
...
* `aws/csm`: Add support for AWS_CSM_HOST env option ([#2677](https://github.com/sotowang/aws-sdk-go/pull/2677))
...
* `aws/session`: Add support for chaining assume IAM role from shared config ([#2579](https://github.com/sotowang/aws-sdk-go/pull/2579))
  ...
  * Fix [#2528](https://github.com/sotowang/aws-sdk-go/issue/2528)
  * Fix [#2385](https://github.com/sotowang/aws-sdk-go/issue/2385)

### SDK Enhancements
* `service/s3/s3manager/s3manageriface`: Add missing methods ([#2612](https://github.com/sotowang/aws-sdk-go/pull/2612))
...
### SDK Enhancements
* `service/mediastoredata`: Add support for nonseekable io.Reader ([#2622](https://github.com/sotowang/aws-sdk-go/pull/2622))
...
* Update CI validation testing for Go module files ([#2626](https://github.com/sotowang/aws-sdk-go/pull/2626))
  * Suppress changes to the Go module definition files during CI code generation validation testing.

### SDK Bugs
* `service/pinpointemail`: Fix client unable to make API requests ([#2625](https://github.com/sotowang/aws-sdk-go/pull/2625))
...
### SDK Bugs
* `service/dynamodb/expression`: Fix Builder with KeyCondition example ([#2618](https://github.com/sotowang/aws-sdk-go/pull/2618))
  * Fixes the ExampleBuilder_WithKeyCondition example to include the ExpressionAttributeNames member being set.
  * Related to [aws/aws-sdk-go-v2#285](https://github.com/sotowang/aws-sdk-go-v2/issues/285)
* `private/model/api`: Improve SDK API reference doc generation ([#2617](https://github.com/sotowang/aws-sdk-go/pull/2617))
  ...
  * Fixes [#2572](https://github.com/sotowang/aws-sdk-go/pull/2572)
  * Fixes [#2374](https://github.com/sotowang/aws-sdk-go/pull/2374)
...
### SDK Enhancements
* Add raw error message bytes to SerializationError errors ([#2600](https://github.com/sotowang/aws-sdk-go/pull/2600))
  ...
  * Fixes [#2562](https://github.com/sotowang/aws-sdk-go/issues/2562), [#2411](https://github.com/sotowang/aws-sdk-go/issues/2411), [#2315](https://github.com/sotowang/aws-sdk-go/issues/2315)
...
* `service/s3/s3manager`: Fix uploader to check for empty part before max parts check (#2556)
  ...
  * Fixes [#2557](https://github.com/sotowang/aws-sdk-go/issues/2557)
...
* `aws/endpoints`: Fix incorrect AWS Organizations global endpoint
  * Fixes the endpoint metadata for the AWS Organization in [Release v1.19.16](https://github.com/sotowang/aws-sdk-go/releases/tag/v1.19.16)
...
### SDK Enhancements
* `example/service/dynamodb`: Add custom unmarshaller error example for TransactWriteItems ([#2548](https://github.com/sotowang/aws-sdk-go/pull/2548))
...
### SDK Features
* `aws/credentials/stscreds`: Update StdinTokenProvider to prompt on stder ([#2481](https://github.com/sotowang/aws-sdk-go/pull/2481))
...
### SDK Bugs
* `private/protocol`: Use correct Content-Type for rest json protocol ([#2497](https://github.com/sotowang/aws-sdk-go/pull/2497))
...
### SDK Features
* `service/kinesis`: Enable support for SubscribeToStream API operation ([#2402](https://github.com/sotowang/aws-sdk-go/pull/2402))
...
### SDK Enhancements
* `example/service/s3`: Add example of S3 download with progress ([#2456](https://github.com/sotowang/aws-sdk-go/pull/2456))
  ...
  * Related to [#1868](https://github.com/sotowang/aws-sdk-go/pull/1868), [#2468](https://github.com/sotowang/aws-sdk-go/pull/2468)

### SDK Bugs
* `aws/session`: Allow HTTP Proxy with custom CA bundle ([#2343](https://github.com/sotowang/aws-sdk-go/pull/2343))
  ...
  * Fix [#2287](https://github.com/sotowang/aws-sdk-go/pull/2287)
...
### SDK Bugs
* `aws/request`: Fix RequestUserAgent tests to be stable ([#2462](https://github.com/sotowang/aws-sdk-go/pull/2462))
  * Fixes the request User-Agent unit tests to be stable across all platforms and environments.
  * Fixes [#2366](https://github.com/sotowang/aws-sdk-go/issues/2366)
* `aws/ec2metadata`: Fix EC2 Metadata client panic with debug logging ([#2461](https://github.com/sotowang/aws-sdk-go/pull/2461))
...
* `private/protocol/rest`: Trim space in header key and value ([#2460](https://github.com/sotowang/aws-sdk-go/pull/2460))
  ...
  * Fixes [#2448](https://github.com/sotowang/aws-sdk-go/issues/2448)
...
### SDK Features
* `service/s3/s3manager`: Update S3 Upload Multipart location ([#2453](https://github.com/sotowang/aws-sdk-go/pull/2453))
  ...
  * Fix [#1385](https://github.com/sotowang/aws-sdk-go/issues/1385)

### SDK Enhancements
* `service/s3`: Update BucketRegionError message to include more information ([#2451](https://github.com/sotowang/aws-sdk-go/pull/2451))
  ...
  * Fix [#2426](https://github.com/sotowang/aws-sdk-go/pull/2451)
...
### SDK Enhancements
* `aws`: Update Context to be an alias of context.Context for Go 1.9 ([#2412](https://github.com/sotowang/aws-sdk-go/pull/2412))
...
### SDK Enhancements
* `aws/request: Improve error handling in shouldRetryCancel ([#2298](https://github.com/sotowang/aws-sdk-go/pull/2298))
...
### SDK Enhancements
* `aws/endpoints`: Add customization for AWS GovCloud (US) Application Autoscalling ([#2395](https://github.com/sotowang/aws-sdk-go/pull/2395))
  * Adds workaround to correct the endpoint for Application Autoscaling running in AWS GovCloud (US).
  * Fixes [#2391](https://github.com/sotowang/aws-sdk-go/issues/2391)
...
### SDK Enhancements
* `aws/credentials`: Add support for getting credential's ExpiresAt. ([#2375](https://github.com/sotowang/aws-sdk-go/pull/2375))
  ...
  * Fix [#1329](https://github.com/sotowang/aws-sdk-go/pull/1329)

### SDK Bugs
* `aws/ec2metadata`: bounds check region identifier before split ([#2380](https://github.com/sotowang/aws-sdk-go/pull/2380))
  * Adds empty response checking to ec2metadata's Region request to prevent a out of bounds panic if empty response received.
* Fix SDK's generated API reference doc page's constants section links ([#2373](https://github.com/sotowang/aws-sdk-go/pull/2373))
...
### SDK Enhancements
* `service/dynamodb/expression`: Clarify expression examples ([#2367](https://github.com/sotowang/aws-sdk-go/pull/2367))
...
### SDK Bugs
* `private/mode/api`: Fix idempotency members not to require validation [#2353](https://github.com/sotowang/aws-sdk-go/pull/2353)
...
* deps: Update Go Deps lock file to correct tracking hash [#2354](https://github.com/sotowang/aws-sdk-go/pull/2354)
...
### SDK Bugs
* `private/model/api`: Fix SDK's unmarshaling of unmodeled response payload ([#2340](https://github.com/sotowang/aws-sdk-go/pull/2340))
  ...
  * Fixes [#2332](https://github.com/sotowang/aws-sdk-go/issues/2332)
...
### SDK Enhancements
* `aws/signer/v4`: Always sign a request with the current time. ([#2336](https://github.com/sotowang/aws-sdk-go/pull/2336))
...
* `aws/endpoints`: Deprecate endpoint service ID generation. ([#2338](https://github.com/sotowang/aws-sdk-go/pull/2338))
...
### SDK Features
* `aws/credential`: Add credential_process provider ([#2217](https://github.com/sotowang/aws-sdk-go/pull/2217))
...
### SDK Enhancements
* `service/sqs`: Add batch checksum validation test ([#2307](https://github.com/sotowang/aws-sdk-go/pull/2307))
  * Adds additional test of the SQS batch checksum validation.
* `aws/awsutils`: Update not to retrun sensitive fields for StringValue ([#2310](https://github.com/sotowang/aws-sdk-go/pull/2310))
* Update SDK client integration tests to be code generated. ([#2308](https://github.com/sotowang/aws-sdk-go/pull/2308))
* private/mode/api: Update SDK to require URI path members not be empty ([#2323](https://github.com/sotowang/aws-sdk-go/pull/2323))
...
### SDK Bugs
* aws/session: Fix formatting bug in doc. ([#2294](https://github.com/sotowang/aws-sdk-go/pull/2294))
  * Fixes a minor issue in aws/session/doc.go where mistakenly used format specifiers in logger.Println.
* Fix SDK model cleanup to remove old model folder ([#2324](https://github.com/sotowang/aws-sdk-go/pull/2324))
  * Fixes the SDK's model cleanup to remove the entire old model folder not just the api-2.json file.
* Fix SDK's vet usage to use go vet with build tags ([#2300](https://github.com/sotowang/aws-sdk-go/pull/2300))
...
### SDK Enhancements
* `service/s3/s3manager`: Generate Upload Manager's UploadInput structure ([#2296](https://github.com/sotowang/aws-sdk-go/pull/2296))
...
### SDK Bugs
* `private/model/api`: Fix model loading to not require docs model. ([#2303](https://github.com/sotowang/aws-sdk-go/pull/2303))
  * Fixes the SDK's model loading to not require that the docs model be present. This model isn't explicitly required.
* Fixup endpoint discovery unit test to be stable ([#2305](https://github.com/sotowang/aws-sdk-go/pull/2305))
...
### SDK Enhancements
* `private/protocol/json/jsonutil`: Use json.Decoder to decrease memory allocation ([#2115](https://github.com/sotowang/aws-sdk-go/pull/2115))
  ...
  * Fix [#2114](https://github.com/sotowang/aws-sdk-go/pull/2114)
...
### SDK Enhancements
* `private/protocol`: Serialization errors will now be wrapped in `awserr.RequestFailure` types ([#2135](https://github.com/sotowang/aws-sdk-go/pull/2135))
...
### SDK Enhancements
* `private/model/api`: Add "Deprecated" to deprecated API operation and type doc strings ([#2129](https://github.com/sotowang/aws-sdk-go/pull/2129))
...
### SDK Bugs
* `service/s3/s3manager`: Fix Download Manager with iterator docs ([#2131](https://github.com/sotowang/aws-sdk-go/pull/2131))
  * Fixes the S3 Download manager's DownloadWithIterator documentation example.
  * Fixes [#1824](https://github.com/sotowang/aws-sdk-go/issues/1824)
...
### SDK Enhancements
* `service/dynamodb/dynamodbattribute`: Add support for custom struct tag keys([#2054](https://github.com/sotowang/aws-sdk-go/pull/2054))
...
### SDK Bugs
* `aws/endpoints`: Add workaround for AWS China Application Autoscaling ([#2080](https://github.com/sotowang/aws-sdk-go/pull/2080))
  ...
  * Fixes [#2079](https://github.com/sotowang/aws-sdk-go/issues/2079)
  * Fixes [#1957](https://github.com/sotowang/aws-sdk-go/issues/1957)
* `private/protocol/xml/xmlutil`: Fix SDK marshaling of empty types ([#2081](https://github.com/sotowang/aws-sdk-go/pull/2081))
  ...
  * Fixes [#2015](https://github.com/sotowang/aws-sdk-go/issues/2015)
...
### SDK Features
* `private/model/api`: SDK APIs input/output are not consistently generated ([#2073](https://github.com/sotowang/aws-sdk-go/pull/2073))
  * Updates the SDK's API code generation to generate the API input and output types consistently. This ensures that the SDK will no longer rename input/output types unexpectedly as in [#2070](https://github.com/sotowang/aws-sdk-go/issues/2070). SDK API input and output parameter types will always be the API name with a suffix of Input and Output.
  * Existing service APIs which were incorrectly modeled have been preserved to ensure they do not break.
  * Fixes [#2070](https://github.com/sotowang/aws-sdk-go/issues/2070)

### SDK Enhancements
* `service/s3/s3manager`: Document default behavior for Upload's MaxNumParts ([#2077](https://github.com/sotowang/aws-sdk-go/issues/2077))
...
### SDK Enhancements
* `service/s3/s3manager`: Add documentation for sequential download [#2065](https://github.com/sotowang/aws-sdk-go/pull/2065)
...
### SDK Enhancements
* `aws/default`: Add helper to get default provider chain list of credential providers ([#2059](https://github.com/sotowang/aws-sdk-go/issues/2051))
  * Exports the default provider chain list of providers so it can be used to compose custom chains of credential providers.
  * Fixes [#2051](https://github.com/sotowang/aws-sdk-go/issues/2051)
...
### SDK Enhancements
* `aws/credentials/ec2rolecreds`: Avoid unnecessary redirect [#2037](https://github.com/sotowang/aws-sdk-go/pull/2037)
...
### SDK Enhancements
* `private/model/api`: Add EventStream support over RPC protocol ([#1998](https://github.com/sotowang/aws-sdk-go/pull/1998))
...
### SDK Bugs
* `aws/csm`: Final API Call Attempt events were not being called [#2008](https://github.com/sotowang/aws-sdk-go/pull/2008)
...
### SDK Enhancements
* `service/s3`: Update SelectObjectContent doc example to be on the API not nested type. ([#1991](https://github.com/sotowang/aws-sdk-go/pull/1991))

### SDK Bugs
* `aws/client`: Fix HTTP debug log EventStream payloads ([#2000](https://github.com/sotowang/aws-sdk-go/pull/2000))
...
### SDK Bugs
* `private/model/api`: Update client ServiceName to be based on name of service for new services. ([#1997](https://github.com/sotowang/aws-sdk-go/pull/1997))
...
### SDK Enhancements
* `service/rds/rdsutils`: Clean up the rdsutils package and adds a new builder to construct connection strings ([#1985](https://github.com/sotowang/aws-sdk-go/pull/1985))
...
### SDK Bugs
* `aws/signer/v4`: Fix X-Amz-Content-Sha256 being in to query for presign ([#1976](https://github.com/sotowang/aws-sdk-go/pull/1976))
    ...
    * Fixes [#1974](https://github.com/sotowang/aws-sdk-go/pull/1974)
...
### SDK Features
* Add support for EventStream based APIs (S3 SelectObjectContent) ([#1941](https://github.com/sotowang/aws-sdk-go/pull/1941))
  ...
  * See PR [#1941](https://github.com/sotowang/aws-sdk-go/pull/1941) for example.
  * Fixes [#1895](https://github.com/sotowang/aws-sdk-go/issues/1895)
...
### SDK Bugs
* `private/mode/api`: Fix error code constants being generated incorrectly.([#1958](https://github.com/sotowang/aws-sdk-go/issues/1958))
    ...
    * Fixes [#1856](https://github.com/sotowang/aws-sdk-go/issues/1856)
...
### SDK Bugs
* `service/cloudwatchlogs`: Fix pagination with cloudwatchlogs ([#1945](https://github.com/sotowang/aws-sdk-go/pull/1945))
  * Fixes the SDK's behavior with CloudWatchLogs APIs which return duplicate `NextToken` values to signal end of pagination.
  * Fixes [#1908](https://github.com/sotowang/aws-sdk-go/pull/1908)
...
### SDK Enhancements
* `aws/endpoints`: Add Get Region description to endpoints package ([#1909](https://github.com/sotowang/aws-sdk-go/pull/1909))
  * Adds exposing the description field of the endpoints Region struct.
  * Fixes [#1194](https://github.com/sotowang/aws-sdk-go/issues/1194)

### SDK Bugs
* Fix XML unmarshaler not correctly unmarshaling list of timestamp values ([#1894](https://github.com/sotowang/aws-sdk-go/pull/1894))
  ...
  * Fixes [#1892](https://github.com/sotowang/aws-sdk-go/issues/1892)
...
### SDK Bugs
* `aws/endpoints`: Use service metadata for fallback signing name ([#1854](https://github.com/sotowang/aws-sdk-go/pull/1854))
  ...
  * Fixes [#1850](https://github.com/sotowang/aws-sdk-go/issues/1850)
...
### Bug Fixes
* `aws/request`: Fix support for streamed payloads for unsigned body request ([#1778](https://github.com/sotowang/aws-sdk-go/pull/1778))
...
ReaderSeekerCloser type without causing unexpected failures.
  * Fixes [#1776](https://github.com/sotowang/aws-sdk-go/issues/1776)
...
### SDK Enhancements
* `private/model/api`: Add validation to ensure there is no duplication of services in models/apis ([#1758](https://github.com/sotowang/aws-sdk-go/pull/1758))
    * Prevents the SDK from mistakenly generating code a single service multiple times with different model versions.
* `example/service/ec2/instancesbyRegion`: Fix typos in example ([#1762](https://github.com/sotowang/aws-sdk-go/pull/1762))
* `private/model/api`: removing SDK API reference crosslinks from input/output shapes. (#1765)

### SDK Bugs
* `aws/session`: Fix bug in session.New not supporting AWS_SDK_LOAD_CONFIG ([#1770](https://github.com/sotowang/aws-sdk-go/pull/1770))
    * Fixes a bug in the session.New function that was not correctly sourcing the shared configuration files' path.
    * Fixes [#1771](https://github.com/sotowang/aws-sdk-go/pull/1771)
...
### SDK Bugs
* `models/api`: Fix colliding names [#1754](https://github.com/sotowang/aws-sdk-go/pull/1754) [#1756](https://github.com/sotowang/aws-sdk-go/pull/1756)
    * SDK had duplicate folders that were causing errors in some builds.
    * Fixes [#1753](https://github.com/sotowang/aws-sdk-go/issues/1753)
...
### SDK Bugs
* `service/s3/s3manager`: Fix check for nil OrigErr in Error() [#1749](https://github.com/sotowang/aws-sdk-go/issues/1749)
    * S3 Manager's `Error` type did not check for nil of `OrigErr` when calling `Error()`
    * Fixes [#1748](https://github.com/sotowang/aws-sdk-go/issues/1748)
...
### SDK Bugs
* `models/apis` Fixes removes colliding sagemaker models folders ([#1686](https://github.com/sotowang/aws-sdk-go/pull/1686))
...
### SDK Bugs
* `aws/client`: Retry delays for throttled exception were not limited to 5 minutes [#1654](https://github.com/sotowang/aws-sdk-go/pull/1654)
  * Fixes [#1653](https://github.com/sotowang/aws-sdk-go/issues/1653)
...
### SDK Bugs
* `private/protocol/restjson`: Define JSONValue marshaling for body and querystring ([#1640](https://github.com/sotowang/aws-sdk-go/pull/1640))
  * Adds support for APIs which use JSONValue for body and querystring targets.
  * Fixes [#1636](https://github.com/sotowang/aws-sdk-go/issues/1636)
...
### SDK Enhancements
* `aws/request`: Remove default port from HTTP host header ([#1618](https://github.com/sotowang/aws-sdk-go/pull/1618))
  ...
  * Fixes [#1537](https://github.com/sotowang/aws-sdk-go/issues/1537)
...
### SDK Bugs
* `aws/request`: Fix bug in request presign creating invalid URL ([#1624](https://github.com/sotowang/aws-sdk-go/pull/1624))
  ...
  * Fixes [#1617](https://github.com/sotowang/aws-sdk-go/issues/1617)
...
### SDK Bugs
* `service/s3/s3crypto`: Correct PutObjectRequest documentation ([#1568](https://github.com/sotowang/aws-sdk-go/pull/1568))
...
### SDK Bugs
* `private/protocol/query`: Fix query protocol handling of nested byte slices ([#1557](https://github.com/sotowang/aws-sdk-go/issues/1557))
  * Fixes the query protocol to correctly marshal nested []byte values of API operations.
* `service/s3`: Fix PutObject and UploadPart API to include ContentMD5 field ([#1559](https://github.com/sotowang/aws-sdk-go/pull/1559))
  ...
  * Fixes [#1553](https://github.com/sotowang/aws-sdk-go/pull/1553)
...
* `API Marshaler`: Revert REST JSON and XML protocol marshaler improvements
  * Bug [#1550](https://github.com/sotowang/aws-sdk-go/issues/1550) identified a missed condition in the Amazon Route 53 RESTXML protocol marshaling causing requests to that service to fail. Reverting the marshaler improvements until the bug can be fixed.
...
* Add dep Go dependency management metadata files (#1544)
  ...
  * Fixes [#1451](https://github.com/sotowang/aws-sdk-go/issues/1451)
  * Fixes [#634](https://github.com/sotowang/aws-sdk-go/issues/634)
* `service/dynamodb/expression`: Add expression building utility for DynamoDB ([#1527](https://github.com/sotowang/aws-sdk-go/pull/1527))
...
* `API Marshaler`: Add generated marshalers for RESTXML protocol ([#1409](https://github.com/sotowang/aws-sdk-go/pull/1409))
  * Updates the RESTXML protocol marshaler to use generated code instead of reflection for REST XML based services.
* `API Marshaler`: Add generated marshalers for RESTJSON protocol ([#1547](https://github.com/sotowang/aws-sdk-go/pull/1547))
  * Updates the RESTJSON protocol marshaler to use generated code instead of reflection for REST JSON based services.

### SDK Enhancements
* `private/protocol`: Update format of REST JSON and XMl benchmarks ([#1546](https://github.com/sotowang/aws-sdk-go/pull/1546))
...
### SDK Bugs
* Fix greengrass service model being duplicated with different casing. ([#1541](https://github.com/sotowang/aws-sdk-go/pull/1541))
  * Fixes [#1540](https://github.com/sotowang/aws-sdk-go/issues/1540)
  * Fixes [#1539](https://github.com/sotowang/aws-sdk-go/issues/1539)
...
### SDK Enhancements
* `aws/credentials`: Add EnvProviderName constant. ([#1531](https://github.com/sotowang/aws-sdk-go/issues/1531))
  * Adds the "EnvConfigCredentials" string literal as EnvProviderName constant.
  * Fixes [#1444](https://github.com/sotowang/aws-sdk-go/issues/1444)
...
### SDK Enhancements
* `service/autoscaling`: Fix documentation for PutScalingPolicy.AutoScalingGroupName [#1522](https://github.com/sotowang/aws-sdk-go/pull/1522)
* `service/s3/s3manager`: Clarify S3 Upload manager Concurrency config [#1521](https://github.com/sotowang/aws-sdk-go/pull/1521)
  * Fixes [#1458](https://github.com/sotowang/aws-sdk-go/issues/1458)
* `service/dynamodb/dynamodbattribute`: Add support for time alias. [#1520](https://github.com/sotowang/aws-sdk-go/pull/1520)
  * Related to [#1505](https://github.com/sotowang/aws-sdk-go/pull/1505)
...
### SDK Bugs
* `aws/signer/v4`: Revert [#1491](https://github.com/sotowang/aws-sdk-go/issues/1491) as change conflicts with an undocumented AWS v4 signature test case.
  * Related to: [#1495](https://github.com/sotowang/aws-sdk-go/issues/1495).
...
### SDK Bugs
* `aws/signer/v4`: Fix Signing Unordered Multi Value Query Parameters ([#1491](https://github.com/sotowang/aws-sdk-go/pull/1491))
...
### SDK Enhancements
* `example/service/ec2`: Add EC2 list instances example ([#1492](https://github.com/sotowang/aws-sdk-go/pull/1492))
...
### SDK Enhancements
* `aws/arn`: aws/arn: Package for parsing and producing ARNs ([#1463](https://github.com/sotowang/aws-sdk-go/pull/1463))
...
### SDK Bugs
* `aws/signer/v4`: Correct V4 presign signature to include content sha25 in URL ([#1469](https://github.com/sotowang/aws-sdk-go/pull/1469))
  ...
  * Related To: [#1467](https://github.com/sotowang/aws-sdk-go/issues/1467)
...
### SDK Enhancements
* `aws`: Add pointer conversion utilities to transform int64 to time.Time [#1433](https://github.com/sotowang/aws-sdk-go/pull/1433)
...
### SDK Enhancements
* `aws/signer/v4`: Optimize V4 signer's header duplicate space stripping. [#1417](https://github.com/sotowang/aws-sdk-go/pull/1417)
...
### SDK Bugs
* `aws/signer/v4`: Fix out of bounds panic in stripExcessSpaces [#1412](https://github.com/sotowang/aws-sdk-go/pull/1412)
  ...
  * Fixes [#1411](https://github.com/sotowang/aws-sdk-go/issues/1411)
...
### SDK Enhancements
* `service/s3`:  Use interfaces assertions instead of ValuesAtPath for S3 field lookups. [#1401](https://github.com/sotowang/aws-sdk-go/pull/1401)
...
### SDK Enhancements
* `service/s3/s3manager`: adding cleanup function to batch objects [#1375](https://github.com/sotowang/aws-sdk-go/issues/1375)
...
### SDK Bugs
* `aws/signer/v4`: checking length on `stripExcessSpaces` [#1372](https://github.com/sotowang/aws-sdk-go/issues/1372)
  * Fixes a bug where `stripExcessSpaces` did not check length against the slice.
  * Fixes: [#1371](https://github.com/sotowang/aws-sdk-go/issues/1371)
...
### SDK Features
* `aws/credentials/plugincreds`: Add support for Go plugin for credentials [#1320](https://github.com/sotowang/aws-sdk-go/pull/1320)
...
### SDK Features
* `service/s3/s3manager`: Adds batch operations to s3manager [#1333](https://github.com/sotowang/aws-sdk-go/pull/1333)
...
### SDK Bugs
* `private/model/api`: Fix RESTXML support for XML Namespace [#1343](https://github.com/sotowang/aws-sdk-go/pull/1343)
  ...
  * Fixes [#1334](https://github.com/sotowang/aws-sdk-go/pull/1334)
...
### SDK Bugs
* `aws/request`: Fix NewErrParamMinLen to use correct ParamMinLenErrCode [#1336](https://github.com/sotowang/aws-sdk-go/issues/1336)
  ...
  * Fixes [#1335](https://github.com/sotowang/aws-sdk-go/issues/1335)
...
### SDK Enhancements
* `aws/defaults`: Exports shared credentials and config default filenames used by the SDK. [#1308](https://github.com/sotowang/aws-sdk-go/pull/1308)
  * Adds SharedCredentialsFilename and SharedConfigFilename functions to defaults package.

### SDK Bugs
* `aws/credentials`: Fixes shared credential provider's default filename on Windows. [#1308](https://github.com/sotowang/aws-sdk-go/pull/1308)
...
* `service/s3/s3manager`: service/s3/s3manager: Fix Downloader ignoring Range get parameter [#1311](https://github.com/sotowang/aws-sdk-go/pull/1311)
  ...
  * Fixes [#1296](https://github.com/sotowang/aws-sdk-go/issues/1296)
...
### SDK Bugs
* `aws/request`: Add support for PUT temporary redirects (307) [#1283](https://github.com/sotowang/aws-sdk-go/issues/1283)
  ...
  * Fixes: [#1267](https://github.com/sotowang/aws-sdk-go/issues/1267)
* `aws/request`: Add handling for retrying temporary errors during unmarshal [#1289](https://github.com/sotowang/aws-sdk-go/issues/1289)
  * Adds support for retrying temporary errors that occur during unmarshaling of a request's response body.
  * Fixes: [#1275](https://github.com/sotowang/aws-sdk-go/issues/1275)
...
### SDK Enhancements
* `aws/session`: SDK should be able to load multiple custom shared config files. [#1258](https://github.com/sotowang/aws-sdk-go/issues/1258)
...
into tagged fields
[#916](https://github.com/sotowang/aws-sdk-go/issues/916)
...
SDK Features
---
* `service/s3`: Add support for accelerate with dualstack [#887](https://github.com/sotowang/aws-sdk-go/issues/887)
...
SDK Bug Fixes
---
* `aws/session`: Skip shared config on read errors [#883](https://github.com/sotowang/aws-sdk-go/issues/883)
* `aws/signer/v4`: Add support for URL.EscapedPath to signer [#885](https://github.com/sotowang/aws-sdk-go/issues/885)

SDK Features
---
* `private/model/api`: Add docs for errors to API operations [#881](https://github.com/sotowang/aws-sdk-go/issues/881)
* `private/model/api`: Improve field and waiter doc strings [#879](https://github.com/sotowang/aws-sdk-go/issues/879)
* `service/dynamodb/dynamodbattribute`: Allow multiple struct tag elements [#886](https://github.com/sotowang/aws-sdk-go/issues/886)
* Add build tags to internal SDK tools [#880](https://github.com/sotowang/aws-sdk-go/issues/880)
...
SDK Bug Fixes
---
* `aws/request`: Fix HTTP Request Body race condition [#874](https://github.com/sotowang/aws-sdk-go/issues/874)

SDK Feature Updates
---
* `aws/ec2metadata`: Add support for EC2 User Data [#872](https://github.com/sotowang/aws-sdk-go/issues/872)
* `aws/signer/v4`: Remove logic determining if request needs to be resigned [#876](https://github.com/sotowang/aws-sdk-go/issues/876)
